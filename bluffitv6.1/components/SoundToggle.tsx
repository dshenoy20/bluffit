...
export function SoundToggle() {
  ...
  // Browsers only allow audio after a user gesture: start the background loop
  // on the first tap/click/keypress anywhere. Idempotent across pages.
  useEffect(() => {
    const start = () => startBackgroundMusic();
