...
- **Round results**: after voting, each player sees a personal result screen (correct rank + points, fooled by whom, bluff bonus, and the round total like "+130 points") for ~6 seconds, then the game auto-advances to the leaderboard. The host makes exactly one click between rounds: Next Round.
